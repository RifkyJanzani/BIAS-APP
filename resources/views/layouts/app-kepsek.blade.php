            ...
            <div class="offcanvas-body">
                <ul class="nav-list">
                    <li data-bs-dismiss="offcanvas">
                        <a href="/kepsek/dashboard" class="{{ request()->is('kepsek/dashboard*') ? 'selected' : '' }}">
                            <p><b>|</b></p><img src="{{ asset('images/Dashboard Icon.svg') }}" alt="">Dashboard
                        </a>
                    </li>
                    <li data-bs-dismiss="offcanvas">
                        <a href="/kepsek/siswa" class="{{ request()->is('kepsek/kelas*') ? 'selected' : '' }}">
                            <p><b>|</b></p><img src="{{ asset('images/Kelas Icon.svg') }}" alt="">Siswa
                        </a>
                    </li>
                    <li data-bs-dismiss="offcanvas">
